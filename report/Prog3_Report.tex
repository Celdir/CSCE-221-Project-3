...
traverses the entire array searching for the smallest element, then swaps
that element into the first position. Then it searches the remainder of the
array for the next-smallest element, then swaps that element into the first 
position of the remainder. On its nth traversal, it will swap the smallest element
into the nth position. This process continues until there is no more ''remainder''
of the array to traverse.\\
